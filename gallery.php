...
<head>
    ...
    <title>Фотогалерея | HAMSTER, Ярославль</title>
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;500;600;700&display=swap">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <style>
        /* Все стили из about.html */
          :root {
            --primary: #003580;
            --secondary: #feba02;
            --accent: #ff6b6b;
    ...
    <section id="gallery-section" class="section">
        ...
        <div class="gallery">
            <div class="gallery-item">
                <img src="\images\бег.jpg" alt="Внешний вид отеля">
            </div>
            <div class="gallery-item">
                <img src="\images\галерея.jpg" alt="Лобби отеля">
            </div>
            <div class="gallery-item">
                <img src="\images\кабинет.jpg" alt="Номер с кроватью Queen-size">
            </div>
            <div class="gallery-item">
                <img src="\images\коридор.jpg" alt="Стандартный двухместный номер">
            </div>
            <div class="gallery-item">
                <img src="\images\ресторан.jpg" alt="Ресторан">
            </div>
            <div class="gallery-item">
                <img src="\images\еда.jpg" alt="Конференц-зал">
            </div>
        </div>
    </section>
