...
<head>
    ...
    <title>Ресторан | HOTELYAR, Ярославль</title>
...
<body>
    ...
    <section id="restaurant-section" class="section">
        <h2>Ресторан</h2>
        <p>Наш ресторан предлагает гостям изысканные блюда европейской и русской кухни, приготовленные из свежих местных продуктов. Уютная атмосфера и профессиональное обслуживание сделают ваше пребывание незабываемым.</p>
        
        <div class="gallery">
            <div class="gallery-item">
                <img src="\images\бара.jpg" alt="Интерьер ресторана">
            </div>
            <div class="gallery-item">
                <img src="\images\блюда.jpg" alt="Блюда нашего ресторана">
            </div>
            <div class="gallery-item">
                <img src="\images\бар.jpg" alt="Лобби-бар">
            </div>
        </div>
        
        <h3>Меню</h3>
        <a href="\pdf\menu.pdf" target="_blank" class="menu-link">Меню Лобби-бара</a><br>
        <a href="\pdf\bar-menu.pdf" target="_blank" class="menu-link">Барная карта</a>
        
        <h3>Часы работы</h3>
        <div class="working-hours">
            <p><strong>Завтрак:</strong> 06:30 - 10:30</p>
            <p><strong>Обед:</strong> 12:00 - 16:00</p>
            <p><strong>Ужин:</strong> 18:00 - 23:00</p>
            <p><strong>Лобби-бар:</strong> круглосуточно</p>
        </div>
        
        <p>Для бронирования столика или получения дополнительной информации, пожалуйста, свяжитесь с нами по телефону: <strong>+7 (473) 123-45-67</strong></p>
    </section>
