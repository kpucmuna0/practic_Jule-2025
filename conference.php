...
<head>
    ...
    <title>Конференц-залы | HAMSTER, Ярославль</title>
...
<body>
    ...
    <section id="conference-section" class="section">
        <h2>Конференц-залы</h2>
        
        <div class="room-card">
            <h3>Малый зал</h3>
            <div class="image-container">
                <img src="/images/малыйзал.jpg" alt="Малый зал" class="book-image" onclick="openModal(this.src)">
            </div>
        </div>
        ...
        <div class="room-card">
            <h3>Большой зал</h3>
            <div class="image-container">
                <img src="/images/большойзал.jpg" alt="Большой зал" class="book-image" onclick="openModal(this.src)">
            </div>
        </div>
        ...
        <ul class="services-list">
            ...
            <li>Фуршеты</li>
            <li>Аренда проекционного оборудования</li>
            <li>Флипчарты и маркерные доски</li>
            <li>Wi-Fi</li>
        </ul>
        
        <p style="text-align: center; margin-top: 30px;">
            Для уточнения деталей и бронирования конференц-залов свяжитесь с нашим отделом мероприятий по телефону: 
            <strong>+7 (123) 456-78-90</strong> или email: <strong>events@gc-osnova.ru</strong>
        </p>
    </section>
    ...
    <script>
        ...
        function openModal(imgSrc) {
            console.log("Trying to open modal with image:", imgSrc);
